      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full text-[#262626]/60 px-3 py-1 leading-6 font-lora text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold font-lora text-text sm:text-6xl">
